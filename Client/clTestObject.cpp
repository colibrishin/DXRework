...
namespace Client::Object
{
  ...
  inline void TestObject::PreUpdate(const float& dt) { Object::PreUpdate(dt); }

  inline void TestObject::Update(const float& dt) { Object::Update(dt); }

  inline void TestObject::PreRender(const float& dt) { Object::PreRender(dt); }

  inline void TestObject::Render(const float& dt) { Object::Render(dt); }

  void TestObject::PostRender(const float& dt) { Object::PostRender(dt); }
} // namespace Client::Object
