...
namespace Client::ComputeShaders
{
	...
	public:
		...
		void SetLightTable(const Weak<Graphics::StructuredBuffer<LightTableSB>>& light_table_ptr)
		{
			m_light_table_ptr_ = light_table_ptr;
		}

		void SetIntersectionTexture(Client::Resource::IntensityTexture& texs)
		{
			m_intersection_texture_ = &texs;
		}

		void SetPositionTexture(Client::Resource::IntensityPositionTexture& texs)
		{
			m_position_texture_ = &texs;
		}
