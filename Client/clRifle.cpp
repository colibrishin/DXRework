...
namespace Client::Object
{
  ...
  void Rifle::PreUpdate(const float& dt) { Object::PreUpdate(dt); }

  void Rifle::Update(const float& dt) { Object::Update(dt); }

  void Rifle::PreRender(const float& dt) { Object::PreRender(dt); }

  void Rifle::Render(const float& dt) { Object::Render(dt); }

  void Rifle::PostRender(const float& dt) { Object::PostRender(dt); }

  void Rifle::FixedUpdate(const float& dt) { Object::FixedUpdate(dt); }
}
