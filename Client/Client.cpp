...
namespace Client
{
	...
	void InitializeFont()
	{
		Resources::Font::Create("DefaultFont", "./consolas.spritefont");
	}
	...
	void Initialize(HWND hwnd)
	{
		...
		boost::mpl::for_each<GET_TYPES(Engine::Script), boost::type<boost::mpl::_>>
				(
	...
	void Tick()
	{
		Manager::Application::GetInstance().Tick();
	}
