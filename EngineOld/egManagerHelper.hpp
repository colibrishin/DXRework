...
namespace Engine
{
	...
	inline Manager::Physics::Graviton& GetGraviton()
	{
		return Manager::Physics::Graviton::GetInstance();
	}

	inline Manager::Graphics::ImGuiManager& GetImGuiManager()
	{
		return Manager::Graphics::ImGuiManager::GetInstance();
	}
	...
	inline Manager::Graphics::RayTracer& GetRayTracer()
	{
		return Manager::Graphics::RayTracer::GetInstance();
	}
} // namespace Engine
