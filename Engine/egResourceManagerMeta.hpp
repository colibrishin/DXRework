...
namespace Engine::Manager
{
	struct MetaResourceLoadDialog
	{
		...
		{
			bool& flag = ResourceManager::m_b_imgui_load_dialog_[boost::mpl::find<
				LoadableResourceTypes, T>::type::pos::value];
			if (flag)
			{
	...
	struct MetaLoadMenu
	{
		...
		void operator()(boost::type<T>) const
		{
			...
			{
				ResourceManager::m_b_imgui_load_dialog_[boost::mpl::find<LoadableResourceTypes, T>::type::pos::value] =
						true;
			}
		}
	};
