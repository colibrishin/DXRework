...
namespace Engine::Resources
{
  ...
  public:
    ...
    void ExtractObject(const StrongScene& scene, const eLayerType layer) const;

    RESOURCE_SELF_INFER_GETTER(Prefab)
    static inline StrongPrefab Create(const std::string& name, const std::filesystem::path& path, const StrongObjectBase& object)
    {
