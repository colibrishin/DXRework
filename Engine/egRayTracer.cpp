...
namespace Engine::Manager::Graphics
{
	...
	bool RayTracer::Ready() const
	{
		return m_b_ready_;
	}

	UINT64 RayTracer::GetInstanceCount() const
	{
		return m_instance_counts_;
	}

	const StructuredBuffer<SBs::LightSB>& RayTracer::GetLightSB() const
	{
