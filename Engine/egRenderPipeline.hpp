...
namespace Engine::Graphic
{
	...
	private:
		...
		inline static std::unordered_map<std::wstring, std::unique_ptr<IShader>> s_shader_map_{};
		...
		inline static std::unordered_map<std::wstring, ComPtr<ID3D11SamplerState>> s_sampler_state_{};
