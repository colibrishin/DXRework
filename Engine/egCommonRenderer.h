...
{
	using CandidateTuple = std::tuple<WeakObjectBase, WeakMaterial, concurrent_vector<SBs::InstanceSB>>;
	using RenderMap = concurrent_hash_map<eRenderComponentType, concurrent_vector<CandidateTuple>>;
