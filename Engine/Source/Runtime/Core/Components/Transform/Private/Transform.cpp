...
namespace Engine::Components
{
	...
	Quaternion Transform::GetWorldRotation() const
	{
		...
		Weak<Transform> tr_p  = FindNextTransform(*this);
	...
	Weak<Transform> Transform::FindNextTransform(const Transform& transform_)
	{
		Weak<Engine::Abstracts::ObjectBase> next = transform_.GetOwner().lock()->GetParent();
