...
#pragma pack(pop)
	...
	struct ENGINE_CORE_API InputInterface
	{
		...
		virtual bool IsKeyDown(const Keys key) const noexcept = 0;
		virtual bool IsKeyPressed(const Keys key) const noexcept = 0;
		virtual bool IsKeyReleased(const Keys key) const noexcept = 0;
