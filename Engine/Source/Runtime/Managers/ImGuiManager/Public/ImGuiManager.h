...
namespace Engine
{
    ...
    protected:
	    [[nodiscard]] bool DoImpl(const std::string_view, std::string&, bool) override;
    };
    ...
    protected:
        [[nodiscard]] bool DoImpl(const std::string_view, float&, float, float, float, bool) override;
    };
    ...
    protected:
	    [[nodiscard]] bool DoImpl(const std::string_view, int&, float, int, int, bool) override;
    };
    ...
    protected:
	    [[nodiscard]] bool DoImpl(const std::string_view, uint32_t&, float, uint32_t, uint32_t, bool) override;
    };
    ...
    protected:
	    [[nodiscard]] bool DoImpl(const std::string_view, uint64_t&, float, uint64_t, uint64_t, bool) override;
    };
    ...
    protected:
	    [[nodiscard]] bool DoImpl(const std::string_view, const std::filesystem::path&) override;
    };
    ...
    protected:
	    [[nodiscard]] bool DoImpl(const std::string_view, float, float) override;
    };
    ...
    protected:
        [[nodiscard]] bool DoImpl(const std::string_view label, int* value, const char* const* label_arr, const size_t arr_size, const bool editable) override;
    };
    ...
    protected:
	    [[nodiscard]] bool DoImpl(const std::string_view, const std::function<void(void*)>) override;
    };
    ...
    protected:
	    [[nodiscard]] bool DoImpl(const std::string_view, const std::string_view, const void*, unsigned long long) override;
    };
    ...
    protected:
        bool DoImpl(const std::string_view text) override;
    };
    ...
    struct ENGINE_IMGUIMANAGER_API ImGuiTableToken : TableToken
    {
        ...
        void End() override;
    protected:
        bool DoImpl(std::string_view label, unsigned long long column_count) override;
    };
    ...
    struct ENGINE_IMGUIMANAGER_API ImGuiTableColumnToken : TableColumnToken
    {
        ...
        void End() override;
    protected:
        bool DoImpl(unsigned long long column) override;
    };
