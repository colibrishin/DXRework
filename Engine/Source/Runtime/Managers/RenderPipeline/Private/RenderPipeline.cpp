...
namespace Engine::Managers
{
	...
	{
		constexpr DXGI_FORMAT default_rtv_format = DXGI_FORMAT_B8G8R8A8_UNORM;
		...
		Shader::Create
				(
				 ...
				 &default_rtv_format, 1, DXGI_FORMAT_D24_UNORM_S8_UINT,
		...
		Shader::Create
				(
				 ...
				 &default_rtv_format, 1, DXGI_FORMAT_D32_FLOAT,
				 D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST, D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE
				);
