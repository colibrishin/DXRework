...
namespace WinAPI
{
    ...
    )
    {
        ...
        default:
        {
            return WinAPI::WinAPIWrapper::GetInstance().MessageHandler(hwnd, umessage, wparam, lparam);
        }
        }
    }
  ...
  {
      WinAPI::WinAPIWrapper::GetInstance().m_registered_handlers_.push_back(func);
  }
} // namespace WinAPI
