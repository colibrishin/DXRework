...
namespace Engine
{
	void DX12GraphicPrimitiveShader::Generate(const Resources::Shader* shader, void* pipeline_signature)
	{
	...
	void DX12GraphicPrimitiveShader::SetNativeSampler(void* sampler)
	{
		GraphicPrimitiveShader::SetNativeSampler(sampler);
		m_sampler_descriptor_heap_ = sampler;
	}

	void DX12GraphicPrimitiveShader::SetNativeShader(void* shader)
	{
