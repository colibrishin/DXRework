...
namespace Engine
{
	...
	public:
		...
		void ChangeLayer(eLayerType to, GlobalEntityID id);
	...
	private:
		...
		// Add cache component from the object.
		void addCacheComponentImpl(const StrongComponent& component, eComponentType type);
		// Remove cache component from the object.
		void removeCacheComponentImpl(const StrongComponent& component, eComponentType type);

		// Add cache script from the object.
		void addCacheScriptImpl(const StrongScript& script, eScriptType type);
		// Remove cache script from the object.
		void removeCacheScriptImpl(const StrongScript& component, eScriptType type);
