...
namespace Engine::Resources
{
	...
	void AnimationsTexture::OnDeserialized()
	{
		Texture3D::OnDeserialized();
	}

	eResourceType AnimationsTexture::GetResourceType() const
	{
	...
	Texture::GenericTextureDescription AnimationsTexture::preEvaluateAnimations(
