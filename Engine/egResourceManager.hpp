...
namespace Engine::Manager
{
	...
	public:
		...
		WeakResource GetResourceByRawPath(const std::filesystem::path& path, eResourceType type);
		WeakResource GetResourceByMetadataPath(const std::filesystem::path& path, eResourceType type);
